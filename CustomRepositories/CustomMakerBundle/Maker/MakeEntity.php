...
final class MakeEntity extends AbstractMaker implements InputAwareMakerInterface
{
    ...
    public function generate( InputInterface $input, ConsoleStyle $io, Generator $generator )
    {
            ...
            if ( $broadcast ) {
                ...
                $generator->generateTemplate(
                    ...
                    [
                        ...
                        'class_name_plural' => Str::asSnakeCase(
                            Str::singularCamelCaseToPluralCamelCase( $shortName )
                        ),
                    ]
                );
            }
        ...
        while ( true ) {
            ...
            if ( is_array( $newField ) ) {
                ...
                $annotationOptions['entityName'] = $input->getArgument( 'name' );
    ...
    private function createClassManipulator(
        ...
        $useAttributes  = $this->doctrineHelper->doesClassUsesAttributes( $className ) &&
    ...
    private function askRelationDetails(
        ...
        $askInverseSide = function ( EntityRelation $relation ) use ( $io ) {
            ...
            if ( EntityRelation::ONE_TO_ONE !== $relation->getType() ) // pluralize!
