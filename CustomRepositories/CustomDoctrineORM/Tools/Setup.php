...
{
    /**
     * Use this method to register all autoload for a downloaded Doctrine library.
     ...
     * @return void
     */
    public static function registerAutoloadDirectory( $directory ): void
    {
    ...
    private static function createCacheInstance( bool $isDevMode, ?Cache $cache ): Cache
    {
        ...
        elseif ( extension_loaded( 'memcached' ) &&
                 ( class_exists( MemcachedCache::class ) || MemcachedAdapter::isSupported() ) ) {
